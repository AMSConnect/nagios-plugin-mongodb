...
def mongo_connect(host=None, port=None, ssl=False, user=None, passwd=None, replica=None, authdb="admin", insecure=False, ssl_ca_cert_file=None, ssl_cert=None, auth_mechanism=None, retry_writes_disabled=False):
    ...
    if ssl:
        if insecure:
            ...
            con_args['tlsAllowInvalidCertificates'] = False
        con_args['ssl'] = ssl
        if ssl_ca_cert_file:
    ...
    # auth changed in pymongo4 https://pymongo.readthedocs.io/en/stable/migrate-to-pymongo4.html#database-authenticate-and-database-logout-are-removed
    if user and passwd:
